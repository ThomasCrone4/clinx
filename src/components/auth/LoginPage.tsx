          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="mt-6 pt-6 border-t border-gray-100">
              <p className="text-sm text-gray-500">
                Schools do not need a separate onboarding login. Request a demo and Clinx will coordinate the next steps directly.
              </p>
              <button
                type="button"
                onClick={() => navigate('/?request-demo=1')}
                className="mt-3 w-full py-2.5 border border-sky-200 text-sky-700 rounded-lg font-medium hover:bg-sky-50 transition-colors"
              >
                Request Demo Access
              </button>
            </div>
