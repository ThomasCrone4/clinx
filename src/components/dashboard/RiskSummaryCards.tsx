...
export default function RiskSummaryCards() {
  ...
  const cards = [
    { label: 'High Risk', count: stats.high, icon: AlertTriangle, color: 'text-red-600', bg: 'bg-red-50', border: 'border-red-100' },
    { label: 'Medium Risk', count: stats.medium, icon: AlertCircle, color: 'text-amber-600', bg: 'bg-amber-50', border: 'border-amber-100' },
    { label: 'Low Risk', count: stats.low, icon: CheckCircle, color: 'text-emerald-600', bg: 'bg-emerald-50', border: 'border-emerald-100' },
  ];
