        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-100">
            {staff.map((member, index) => (
              <tr key={`${member.email}-${index}`} className="hover:bg-gray-50/50">
                ...
                <td className="px-4 py-3">
                  <span className="text-xs font-medium bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full">{member.status}</span>
                </td>
                <td className="px-4 py-3">
